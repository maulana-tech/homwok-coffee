      ...
      <div className="p-3 border-t border-border">
        {!collapsed && (
          <div className="mb-3 px-2 space-y-0.5">
            <p className="font-medium text-sm uppercase truncate leading-none">{user.nama_lengkap}</p>
        ...
        <button
          ...
          className={cn(
            "flex items-center gap-3 rounded-md px-3 py-2.5 w-full border border-transparent text-destructive transition-colors hover:bg-destructive hover:text-destructive-foreground hover:border-destructive",
            collapsed && "justify-center",
          )}
        >
          <LogOut size={20} />
